...
- [ ] **TIM: deploy `salesforce/v5-attribute-sync-fields/`** + Read/Edit FLS for the integration user.
...
- [ ] **TIM: run `scripts/wire-attributes-sync-route.ps1`**, then redeploy `sundial-acumatica-budget-push` (the route dispatches on the new code).
