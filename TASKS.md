...
- [ ] Job report follow-ups: a "report not sent" marker on the Service jobs list (the cache has `report_sent_at` now); drag-to-reorder sections; a photo's tech caption pre-filling the description.
...
- [ ] **Tim's item 7 (2026-09-19)** — the message cut off after "7."; ask.
