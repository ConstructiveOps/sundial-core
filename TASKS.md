...
- [ ] **Board follow-ups:** FullCalendar Premium (edge-drag resize, week timeline) when the license lands — same API; travel-time hints + tech map (design §8). ~~the tech PWA~~ → built (amendment 7).
