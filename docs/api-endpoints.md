...
| `sundial-service-board` | GET /service/board, GET+POST /service/jobs/{id}/calls, PATCH /service/calls/{id}, POST /service/calls/{id}/cancel; **the tech app:** GET /service/tech/day, GET /service/tech/price-book, GET /service/tech/calls/{id}, POST …/status, …/notes, …/checklist, …/photos, …/photos/confirm, GET …/photos |
