...
export const ACTION_SCOPES = Object.freeze({
  ...
  "service.sms.send": Object.freeze([SCOPES.TENANT]),
...
export function userFilter(access) {
  const a = ctx(access);
  if (a.scope === SCOPES.NONE || a.scope === SCOPES.TECH) return { deny: true, code: DENY.MODULE_FORBIDDEN };
