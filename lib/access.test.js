...
const MODULE_MATRIX = {
  ...
  //               customer solar roofing commercial po  po_credit estimate job servicecall pricebookitem serviceline serviceinvoice servicepayment user
  Executive:      ["y",     "y",  "y",    "y",       "y", "y",     "y",     "y", "y",        "y",          "y",        "y",           "y",           "y"],
  Admin:          ["y",     "y",  "y",    "y",       "y", "y",     "y",     "y", "y",        "y",          "y",        "y",           "y",           "y"],
  Manager:        ["y",     "y",  "y",    "y",       "y", "y",     "y",     "y", "y",        "y",          "y",        "y",           "y",           "y"],
  "Sales Dealer": ["y",     "y",  "n",    "n",       "n", "n",     "n",     "n", "n",        "n",          "n",        "n",           "n",           "y"],
  "Sales Rep":    ["y",     "y",  "n",    "n",       "n", "n",     "n",     "n", "n",        "n",          "n",        "n",           "n",           "y"],
  Technician:     ["n",     "n",  "n",    "n",       "n", "n",     "n",     "n", "n",        "n",          "n",        "n",           "n",           "n"],
};
const OBJECT_ORDER = ["customer", "solar", "roofing", "commercial", "po", "po_credit", "estimate", "job", "servicecall", "pricebookitem", "serviceline", "serviceinvoice", "servicepayment", "user"];
