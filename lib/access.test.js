...
const MODULE_MATRIX = {
  ...
  // yes, sales scopes no (same reasoning as roofing). Technician stays all-"n" for
  // now: the tech PWA gets its own deliberate scope when it lands
  // (docs/pwa-architecture.md), not a side effect of these columns existing.
