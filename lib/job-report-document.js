...
import { buildInvoiceModel, DEFAULT_BRAND, dateOnly, money } from "./estimate-document.js";
...
export function buildJobReportModel({ job, report, photos = [], invoice = null, lines = [], payments = [], estimate = null, brand = {}, options = {} }) {
  ...
  return {
    ...
    number,
    brand: { companyName: b.companyName || "Job report", lines: brandLines, termsUrl: b.termsUrl || "", footerNote: b.footerNote || "", accentColor: b.accentColor },
    metaLines,
    customerLines,
