...
export const EVENTS = Object.freeze({
  ...
  // Service Club (D-073): the membership row's life, keyed by record only (no job).
  MEMBERSHIP_STARTED: "membership_started",
  MEMBERSHIP_UPDATED: "membership_updated",
  MEMBERSHIP_CANCELLED: "membership_cancelled",
  MEMBERSHIP_PAYMENT: "membership_payment",
  INVOICE_SENT: "invoice_sent",
  JOB_REPORT_SENT: "job_report_sent", // the customer's job report + receipt went out (D-072 am. 10)
  INVOICE_ISSUED: "invoice_issued",
  INVOICE_VOIDED: "invoice_voided",
  PAYMENT_RECORDED: "payment_recorded",
  LABOR_BILLED: "labor_billed", // the office opted a call's hours in/out of the customer's bill
  ...
  SERVICE_CALL_CLOCK: "service_call_clock", // tech app: on my way / clocked in / clocked out (details.status, details.at)
  SERVICE_CALL_NOTE: "service_call_note", // tech app: a stamped work / private note was appended
  SERVICE_CALL_PHOTO: "service_call_photo", // tech app: a photo landed in SUNDIAL/{jobId}/photos/{callId}/
